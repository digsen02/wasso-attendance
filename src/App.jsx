          ...
          <div className="month-card">
            ...
            <div className="metric-row">
              ...
              <div>
                ...
                <span>
                  <small>제출 일시</small>
                  <b>{formatDateTime(report?.submittedAt)}</b>
                </span>
              </div>
            </div>
          ...
          <div className="panel company-panel">
            ...
            <div className="company-content">
              <dl>
                ...
                <dt>학교</dt>
                <dd>{state.currentUser.school}</dd>
                <dt>실습 기간</dt>
                <dd>
    ...
    <Shell role={Role.STUDENT}>
      <div className="workspace profile">
        <PageHead
          eyebrow="MY PROFILE"
          title="학생 프로필"
          description="내 정보와 현장실습 정보를 확인합니다."
        />
      ...
      <div className="workspace admin-dashboard">
        ...
        <div className="metrics">
          ...
          <Metric
            label="제출률"
            value={
              rows.length ? ((completed / rows.length) * 100).toFixed(1) : 0
            }
            suffix="%"
            Icon={BarChart3}
          />
    ...
    <Shell role={Role.ADMIN}>
      <div className="workspace">
        ...
        <section className="panel student-list">
          ...
          {filtered.length ? (
            <StudentTable rows={filtered} onSelect={setSelected} />
          ) : (
